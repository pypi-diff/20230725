# Comparing `tmp/vegafusion-1.4.0rc3.tar.gz` & `tmp/vegafusion-1.4.0rc5.tar.gz`
...
+gzip compressed data, was "vegafusion-1.4.0rc5.tar", last modified: Tue Jul 25 16:18:13 2023, max compression
```

## Comparing `vegafusion-1.4.0rc3.tar` & `vegafusion-1.4.0rc5.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 16:18:13.301904 vegafusion-1.4.0rc5/
+-rw-r--r--   0 runner    (1001) docker     (123)     1503 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/LICENSE.txt
+-rw-r--r--   0 runner    (1001) docker     (123)     1121 2023-07-25 16:18:13.301904 vegafusion-1.4.0rc5/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      525 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/README.md
+-rw-r--r--   0 runner    (1001) docker     (123)      189 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/pyproject.toml
+-rw-r--r--   0 runner    (1001) docker     (123)     1005 2023-07-25 16:18:13.301904 vegafusion-1.4.0rc5/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (123)       38 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/setup.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 16:18:13.297904 vegafusion-1.4.0rc5/tests/
+-rw-r--r--   0 runner    (1001) docker     (123)     1142 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/tests/test_conext_manager.py
+-rw-r--r--   0 runner    (1001) docker     (123)    18632 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/tests/test_input_utc.py
+-rw-r--r--   0 runner    (1001) docker     (123)    45595 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/tests/test_pretransform.py
+-rw-r--r--   0 runner    (1001) docker     (123)     3999 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/tests/test_pretransform_specs.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1023 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/tests/test_row_limit.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1578 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/tests/test_save.py
+-rw-r--r--   0 runner    (1001) docker     (123)    14206 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/tests/test_transformed_data.py
+-rw-r--r--   0 runner    (1001) docker     (123)     2843 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/tests/test_transformer.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 16:18:13.301904 vegafusion-1.4.0rc5/vegafusion/
+-rw-r--r--   0 runner    (1001) docker     (123)     4073 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)       26 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/_version.py
+-rw-r--r--   0 runner    (1001) docker     (123)      762 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/compilers.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 16:18:13.301904 vegafusion-1.4.0rc5/vegafusion/connection/
+-rw-r--r--   0 runner    (1001) docker     (123)     5518 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/connection/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)    13181 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/connection/duckdb.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 16:18:13.301904 vegafusion-1.4.0rc5/vegafusion/dataset/
+-rw-r--r--   0 runner    (1001) docker     (123)      105 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/dataset/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)     5821 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/dataset/dataframe.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1372 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/dataset/duckdb.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1785 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/dataset/sql.py
+-rw-r--r--   0 runner    (1001) docker     (123)      350 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/embed.py
+-rw-r--r--   0 runner    (1001) docker     (123)     7992 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/evaluation.py
+-rw-r--r--   0 runner    (1001) docker     (123)      347 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/jupyter.py
+-rw-r--r--   0 runner    (1001) docker     (123)     1318 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/local_tz.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 16:18:13.301904 vegafusion-1.4.0rc5/vegafusion/proto/
+-rw-r--r--   0 runner    (1001) docker     (123)        0 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/proto/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)    63111 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/proto/datafusion_pb2.py
+-rw-r--r--   0 runner    (1001) docker     (123)     2693 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/renderer.py
+-rw-r--r--   0 runner    (1001) docker     (123)    27356 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/runtime.py
+-rw-r--r--   0 runner    (1001) docker     (123)     4267 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/save.py
+-rw-r--r--   0 runner    (1001) docker     (123)     8485 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/transformer.py
+-rw-r--r--   0 runner    (1001) docker     (123)      781 2023-07-25 16:17:00.000000 vegafusion-1.4.0rc5/vegafusion/utils.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-25 16:18:13.301904 vegafusion-1.4.0rc5/vegafusion.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)     1121 2023-07-25 16:18:13.000000 vegafusion-1.4.0rc5/vegafusion.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      955 2023-07-25 16:18:13.000000 vegafusion-1.4.0rc5/vegafusion.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-25 16:18:13.000000 vegafusion-1.4.0rc5/vegafusion.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)      117 2023-07-25 16:18:13.000000 vegafusion-1.4.0rc5/vegafusion.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       11 2023-07-25 16:18:13.000000 vegafusion-1.4.0rc5/vegafusion.egg-info/top_level.txt
```

### Comparing `vegafusion-1.4.0rc3/LICENSE.txt` & `vegafusion-1.4.0rc5/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/PKG-INFO` & `vegafusion-1.4.0rc5/PKG-INFO`
...
### Comparing `vegafusion-1.4.0rc3/README.md` & `vegafusion-1.4.0rc5/README.md`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/setup.cfg` & `vegafusion-1.4.0rc5/setup.cfg`
...
+	vegafusion-python-embed==1.4.0-rc5
...
### Comparing `vegafusion-1.4.0rc3/tests/test_conext_manager.py` & `vegafusion-1.4.0rc5/tests/test_conext_manager.py`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/tests/test_input_utc.py` & `vegafusion-1.4.0rc5/tests/test_input_utc.py`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/tests/test_pretransform.py` & `vegafusion-1.4.0rc5/tests/test_pretransform.py`
...
### Comparing `vegafusion-1.4.0rc3/tests/test_pretransform_specs.py` & `vegafusion-1.4.0rc5/tests/test_pretransform_specs.py`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/tests/test_row_limit.py` & `vegafusion-1.4.0rc5/tests/test_row_limit.py`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/tests/test_save.py` & `vegafusion-1.4.0rc5/tests/test_save.py`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/tests/test_transformed_data.py` & `vegafusion-1.4.0rc5/tests/test_transformed_data.py`
...
### Comparing `vegafusion-1.4.0rc3/tests/test_transformer.py` & `vegafusion-1.4.0rc5/tests/test_transformer.py`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/vegafusion/__init__.py` & `vegafusion-1.4.0rc5/vegafusion/__init__.py`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/vegafusion/compilers.py` & `vegafusion-1.4.0rc5/vegafusion/compilers.py`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/vegafusion/connection/__init__.py` & `vegafusion-1.4.0rc5/vegafusion/connection/__init__.py`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/vegafusion/connection/duckdb.py` & `vegafusion-1.4.0rc5/vegafusion/connection/duckdb.py`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/vegafusion/dataset/dataframe.py` & `vegafusion-1.4.0rc5/vegafusion/dataset/dataframe.py`
...
### Comparing `vegafusion-1.4.0rc3/vegafusion/dataset/duckdb.py` & `vegafusion-1.4.0rc5/vegafusion/dataset/duckdb.py`
...
### Comparing `vegafusion-1.4.0rc3/vegafusion/dataset/sql.py` & `vegafusion-1.4.0rc5/vegafusion/dataset/sql.py`
...
### Comparing `vegafusion-1.4.0rc3/vegafusion/evaluation.py` & `vegafusion-1.4.0rc5/vegafusion/evaluation.py`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/vegafusion/local_tz.py` & `vegafusion-1.4.0rc5/vegafusion/local_tz.py`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/vegafusion/proto/datafusion_pb2.py` & `vegafusion-1.4.0rc5/vegafusion/proto/datafusion_pb2.py`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/vegafusion/renderer.py` & `vegafusion-1.4.0rc5/vegafusion/renderer.py`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/vegafusion/runtime.py` & `vegafusion-1.4.0rc5/vegafusion/runtime.py`
...
### Comparing `vegafusion-1.4.0rc3/vegafusion/save.py` & `vegafusion-1.4.0rc5/vegafusion/save.py`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/vegafusion/transformer.py` & `vegafusion-1.4.0rc5/vegafusion/transformer.py`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/vegafusion/utils.py` & `vegafusion-1.4.0rc5/vegafusion/utils.py`

 * *Files identical despite different names*

### Comparing `vegafusion-1.4.0rc3/vegafusion.egg-info/PKG-INFO` & `vegafusion-1.4.0rc5/vegafusion.egg-info/PKG-INFO`
...
### Comparing `vegafusion-1.4.0rc3/vegafusion.egg-info/SOURCES.txt` & `vegafusion-1.4.0rc5/vegafusion.egg-info/SOURCES.txt`
