# Comparing `tmp/tablemap-0.3.4.tar.gz` & `tmp/tablemap-0.3.5.tar.gz`
...
## Comparing `tablemap-0.3.4.tar` & `tablemap-0.3.5.tar`
...
### Comparing `tablemap-0.3.4/LICENSE` & `tablemap-0.3.5/LICENSE`

 * *Files identical despite different names*

### Comparing `tablemap-0.3.4/README.md` & `tablemap-0.3.5/README.md`

 * *Files identical despite different names*

### Comparing `tablemap-0.3.4/tablemap/tablemap.py` & `tablemap-0.3.5/tablemap/tablemap.py`
...
### Comparing `tablemap-0.3.4/test/test_core.py` & `tablemap-0.3.5/test/test_core.py`
