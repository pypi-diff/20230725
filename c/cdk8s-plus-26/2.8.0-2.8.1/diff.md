# Comparing `tmp/cdk8s-plus-26-2.8.0.tar.gz` & `tmp/cdk8s-plus-26-2.8.1.tar.gz`
...
## Comparing `cdk8s-plus-26-2.8.0.tar` & `cdk8s-plus-26-2.8.1.tar`
...
### Comparing `cdk8s-plus-26-2.8.0/LICENSE` & `cdk8s-plus-26-2.8.1/LICENSE`

 * *Files identical despite different names*

### Comparing `cdk8s-plus-26-2.8.0/PKG-INFO` & `cdk8s-plus-26-2.8.1/PKG-INFO`
...
### Comparing `cdk8s-plus-26-2.8.0/README.md` & `cdk8s-plus-26-2.8.1/README.md`

 * *Files identical despite different names*

### Comparing `cdk8s-plus-26-2.8.0/setup.py` & `cdk8s-plus-26-2.8.1/setup.py`
...
### Comparing `cdk8s-plus-26-2.8.0/src/cdk8s_plus_26/__init__.py` & `cdk8s-plus-26-2.8.1/src/cdk8s_plus_26/__init__.py`

 * *Files identical despite different names*

### Comparing `cdk8s-plus-26-2.8.0/src/cdk8s_plus_26/k8s/__init__.py` & `cdk8s-plus-26-2.8.1/src/cdk8s_plus_26/k8s/__init__.py`

 * *Files identical despite different names*

### Comparing `cdk8s-plus-26-2.8.0/src/cdk8s_plus_26.egg-info/PKG-INFO` & `cdk8s-plus-26-2.8.1/src/cdk8s_plus_26.egg-info/PKG-INFO`
