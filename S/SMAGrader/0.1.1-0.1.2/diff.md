# Comparing `tmp/SMAGrader-0.1.1.tar.gz` & `tmp/SMAGrader-0.1.2.tar.gz`
...
## Comparing `SMAGrader-0.1.1.tar` & `SMAGrader-0.1.2.tar`
...
### Comparing `SMAGrader-0.1.1/SMAGrader/checker.py` & `SMAGrader-0.1.2/SMAGrader/checker.py`
