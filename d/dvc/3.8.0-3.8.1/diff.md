# Comparing `tmp/dvc-3.8.0.tar.gz` & `tmp/dvc-3.8.1.tar.gz`
...
### Comparing `dvc-3.8.0/.git-blame-ignore-revs` & `dvc-3.8.1/.git-blame-ignore-revs`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/.github/ISSUE_TEMPLATE/bug_report.md` & `dvc-3.8.1/.github/ISSUE_TEMPLATE/bug_report.md`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/.github/ISSUE_TEMPLATE/epic_story.md` & `dvc-3.8.1/.github/ISSUE_TEMPLATE/epic_story.md`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/.github/workflows/build.yaml` & `dvc-3.8.1/.github/workflows/build.yaml`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/.github/workflows/codeql.yml` & `dvc-3.8.1/.github/workflows/codeql.yml`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/.github/workflows/plugin_tests.yaml` & `dvc-3.8.1/.github/workflows/plugin_tests.yaml`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/.github/workflows/tests.yaml` & `dvc-3.8.1/.github/workflows/tests.yaml`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/.pre-commit-config.yaml` & `dvc-3.8.1/.pre-commit-config.yaml`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/.pre-commit-hooks.yaml` & `dvc-3.8.1/.pre-commit-hooks.yaml`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/CODE_OF_CONDUCT.md` & `dvc-3.8.1/CODE_OF_CONDUCT.md`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/LICENSE` & `dvc-3.8.1/LICENSE`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/PKG-INFO` & `dvc-3.8.1/PKG-INFO`
...
### Comparing `dvc-3.8.0/README.rst` & `dvc-3.8.1/README.rst`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/__pyinstaller/hook-dvc.py` & `dvc-3.8.1/dvc/__pyinstaller/hook-dvc.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/_debug.py` & `dvc-3.8.1/dvc/_debug.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/analytics.py` & `dvc-3.8.1/dvc/analytics.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/annotations.py` & `dvc-3.8.1/dvc/annotations.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/api/data.py` & `dvc-3.8.1/dvc/api/data.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/api/experiments.py` & `dvc-3.8.1/dvc/api/experiments.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/api/scm.py` & `dvc-3.8.1/dvc/api/scm.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/api/show.py` & `dvc-3.8.1/dvc/api/show.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/cachemgr.py` & `dvc-3.8.1/dvc/cachemgr.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/cli/__init__.py` & `dvc-3.8.1/dvc/cli/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/cli/command.py` & `dvc-3.8.1/dvc/cli/command.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/cli/completion.py` & `dvc-3.8.1/dvc/cli/completion.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/cli/parser.py` & `dvc-3.8.1/dvc/cli/parser.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/cli/utils.py` & `dvc-3.8.1/dvc/cli/utils.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/add.py` & `dvc-3.8.1/dvc/commands/add.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/cache.py` & `dvc-3.8.1/dvc/commands/cache.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/check_ignore.py` & `dvc-3.8.1/dvc/commands/check_ignore.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/checkout.py` & `dvc-3.8.1/dvc/commands/checkout.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/commit.py` & `dvc-3.8.1/dvc/commands/commit.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/completion.py` & `dvc-3.8.1/dvc/commands/completion.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/config.py` & `dvc-3.8.1/dvc/commands/config.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/daemon.py` & `dvc-3.8.1/dvc/commands/daemon.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/dag.py` & `dvc-3.8.1/dvc/commands/dag.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/data.py` & `dvc-3.8.1/dvc/commands/data.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/data_sync.py` & `dvc-3.8.1/dvc/commands/data_sync.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/destroy.py` & `dvc-3.8.1/dvc/commands/destroy.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/diff.py` & `dvc-3.8.1/dvc/commands/diff.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/experiments/__init__.py` & `dvc-3.8.1/dvc/commands/experiments/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/experiments/apply.py` & `dvc-3.8.1/dvc/commands/experiments/apply.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/experiments/branch.py` & `dvc-3.8.1/dvc/commands/experiments/branch.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/experiments/clean.py` & `dvc-3.8.1/dvc/commands/experiments/clean.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/experiments/diff.py` & `dvc-3.8.1/dvc/commands/experiments/diff.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/experiments/exec_run.py` & `dvc-3.8.1/dvc/commands/experiments/exec_run.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/experiments/ls.py` & `dvc-3.8.1/dvc/commands/experiments/ls.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/experiments/pull.py` & `dvc-3.8.1/dvc/commands/experiments/pull.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/experiments/push.py` & `dvc-3.8.1/dvc/commands/experiments/push.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/experiments/queue_worker.py` & `dvc-3.8.1/dvc/commands/experiments/queue_worker.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/experiments/remove.py` & `dvc-3.8.1/dvc/commands/experiments/remove.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/experiments/run.py` & `dvc-3.8.1/dvc/commands/experiments/run.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/experiments/save.py` & `dvc-3.8.1/dvc/commands/experiments/save.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/experiments/show.py` & `dvc-3.8.1/dvc/commands/experiments/show.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/freeze.py` & `dvc-3.8.1/dvc/commands/freeze.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/gc.py` & `dvc-3.8.1/dvc/commands/gc.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/get.py` & `dvc-3.8.1/dvc/commands/get.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/get_url.py` & `dvc-3.8.1/dvc/commands/get_url.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/git_hook.py` & `dvc-3.8.1/dvc/commands/git_hook.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/imp.py` & `dvc-3.8.1/dvc/commands/imp.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/imp_url.py` & `dvc-3.8.1/dvc/commands/imp_url.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/init.py` & `dvc-3.8.1/dvc/commands/init.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/install.py` & `dvc-3.8.1/dvc/commands/install.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/ls/__init__.py` & `dvc-3.8.1/dvc/commands/ls/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/ls/ls_colors.py` & `dvc-3.8.1/dvc/commands/ls/ls_colors.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/ls_url.py` & `dvc-3.8.1/dvc/commands/ls_url.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/machine.py` & `dvc-3.8.1/dvc/commands/machine.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/metrics.py` & `dvc-3.8.1/dvc/commands/metrics.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/move.py` & `dvc-3.8.1/dvc/commands/move.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/params.py` & `dvc-3.8.1/dvc/commands/params.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/plots.py` & `dvc-3.8.1/dvc/commands/plots.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/queue/__init__.py` & `dvc-3.8.1/dvc/commands/queue/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/queue/kill.py` & `dvc-3.8.1/dvc/commands/queue/kill.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/queue/logs.py` & `dvc-3.8.1/dvc/commands/queue/logs.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/queue/remove.py` & `dvc-3.8.1/dvc/commands/queue/remove.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/queue/start.py` & `dvc-3.8.1/dvc/commands/queue/start.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/queue/status.py` & `dvc-3.8.1/dvc/commands/queue/status.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/queue/stop.py` & `dvc-3.8.1/dvc/commands/queue/stop.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/remote.py` & `dvc-3.8.1/dvc/commands/remote.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/remove.py` & `dvc-3.8.1/dvc/commands/remove.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/repro.py` & `dvc-3.8.1/dvc/commands/repro.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/root.py` & `dvc-3.8.1/dvc/commands/root.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/stage.py` & `dvc-3.8.1/dvc/commands/stage.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/status.py` & `dvc-3.8.1/dvc/commands/status.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/unprotect.py` & `dvc-3.8.1/dvc/commands/unprotect.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/update.py` & `dvc-3.8.1/dvc/commands/update.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/commands/version.py` & `dvc-3.8.1/dvc/commands/version.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/compare.py` & `dvc-3.8.1/dvc/compare.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/config.py` & `dvc-3.8.1/dvc/config.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/config_schema.py` & `dvc-3.8.1/dvc/config_schema.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/daemon.py` & `dvc-3.8.1/dvc/daemon.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/dagascii.py` & `dvc-3.8.1/dvc/dagascii.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/data_cloud.py` & `dvc-3.8.1/dvc/data_cloud.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/dependency/__init__.py` & `dvc-3.8.1/dvc/dependency/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/dependency/base.py` & `dvc-3.8.1/dvc/dependency/base.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/dependency/param.py` & `dvc-3.8.1/dvc/dependency/param.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/dependency/repo.py` & `dvc-3.8.1/dvc/dependency/repo.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/dirs.py` & `dvc-3.8.1/dvc/dirs.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/dvcfile.py` & `dvc-3.8.1/dvc/dvcfile.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/env.py` & `dvc-3.8.1/dvc/env.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/exceptions.py` & `dvc-3.8.1/dvc/exceptions.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/fs/__init__.py` & `dvc-3.8.1/dvc/fs/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/fs/callbacks.py` & `dvc-3.8.1/dvc/fs/callbacks.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/fs/data.py` & `dvc-3.8.1/dvc/fs/data.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/fs/dvc.py` & `dvc-3.8.1/dvc/fs/dvc.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/fs/git.py` & `dvc-3.8.1/dvc/fs/git.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/ignore.py` & `dvc-3.8.1/dvc/ignore.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/info.py` & `dvc-3.8.1/dvc/info.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/lock.py` & `dvc-3.8.1/dvc/lock.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/logger.py` & `dvc-3.8.1/dvc/logger.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/machine/__init__.py` & `dvc-3.8.1/dvc/machine/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/machine/backend/base.py` & `dvc-3.8.1/dvc/machine/backend/base.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/machine/backend/terraform.py` & `dvc-3.8.1/dvc/machine/backend/terraform.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/output.py` & `dvc-3.8.1/dvc/output.py`
...
### Comparing `dvc-3.8.0/dvc/parsing/__init__.py` & `dvc-3.8.1/dvc/parsing/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/parsing/context.py` & `dvc-3.8.1/dvc/parsing/context.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/parsing/interpolate.py` & `dvc-3.8.1/dvc/parsing/interpolate.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/pathspec_math.py` & `dvc-3.8.1/dvc/pathspec_math.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/progress.py` & `dvc-3.8.1/dvc/progress.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/prompt.py` & `dvc-3.8.1/dvc/prompt.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/render/convert.py` & `dvc-3.8.1/dvc/render/convert.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/render/converter/__init__.py` & `dvc-3.8.1/dvc/render/converter/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/render/converter/image.py` & `dvc-3.8.1/dvc/render/converter/image.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/render/converter/vega.py` & `dvc-3.8.1/dvc/render/converter/vega.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/render/match.py` & `dvc-3.8.1/dvc/render/match.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/__init__.py` & `dvc-3.8.1/dvc/repo/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/add.py` & `dvc-3.8.1/dvc/repo/add.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/artifacts.py` & `dvc-3.8.1/dvc/repo/artifacts.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/brancher.py` & `dvc-3.8.1/dvc/repo/brancher.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/checkout.py` & `dvc-3.8.1/dvc/repo/checkout.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/collect.py` & `dvc-3.8.1/dvc/repo/collect.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/commit.py` & `dvc-3.8.1/dvc/repo/commit.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/data.py` & `dvc-3.8.1/dvc/repo/data.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/destroy.py` & `dvc-3.8.1/dvc/repo/destroy.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/diff.py` & `dvc-3.8.1/dvc/repo/diff.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/__init__.py` & `dvc-3.8.1/dvc/repo/experiments/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/apply.py` & `dvc-3.8.1/dvc/repo/experiments/apply.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/branch.py` & `dvc-3.8.1/dvc/repo/experiments/branch.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/brancher.py` & `dvc-3.8.1/dvc/repo/experiments/brancher.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/cache.py` & `dvc-3.8.1/dvc/repo/experiments/cache.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/collect.py` & `dvc-3.8.1/dvc/repo/experiments/collect.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/diff.py` & `dvc-3.8.1/dvc/repo/experiments/diff.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/exceptions.py` & `dvc-3.8.1/dvc/repo/experiments/exceptions.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/executor/base.py` & `dvc-3.8.1/dvc/repo/experiments/executor/base.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/executor/local.py` & `dvc-3.8.1/dvc/repo/experiments/executor/local.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/executor/ssh.py` & `dvc-3.8.1/dvc/repo/experiments/executor/ssh.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/ls.py` & `dvc-3.8.1/dvc/repo/experiments/ls.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/pull.py` & `dvc-3.8.1/dvc/repo/experiments/pull.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/push.py` & `dvc-3.8.1/dvc/repo/experiments/push.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/queue/base.py` & `dvc-3.8.1/dvc/repo/experiments/queue/base.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/queue/celery.py` & `dvc-3.8.1/dvc/repo/experiments/queue/celery.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/queue/remove.py` & `dvc-3.8.1/dvc/repo/experiments/queue/remove.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/queue/tasks.py` & `dvc-3.8.1/dvc/repo/experiments/queue/tasks.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/queue/tempdir.py` & `dvc-3.8.1/dvc/repo/experiments/queue/tempdir.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/queue/utils.py` & `dvc-3.8.1/dvc/repo/experiments/queue/utils.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/queue/workspace.py` & `dvc-3.8.1/dvc/repo/experiments/queue/workspace.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/refs.py` & `dvc-3.8.1/dvc/repo/experiments/refs.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/remove.py` & `dvc-3.8.1/dvc/repo/experiments/remove.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/run.py` & `dvc-3.8.1/dvc/repo/experiments/run.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/save.py` & `dvc-3.8.1/dvc/repo/experiments/save.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/serialize.py` & `dvc-3.8.1/dvc/repo/experiments/serialize.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/show.py` & `dvc-3.8.1/dvc/repo/experiments/show.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/stash.py` & `dvc-3.8.1/dvc/repo/experiments/stash.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/experiments/utils.py` & `dvc-3.8.1/dvc/repo/experiments/utils.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/fetch.py` & `dvc-3.8.1/dvc/repo/fetch.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/gc.py` & `dvc-3.8.1/dvc/repo/gc.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/get.py` & `dvc-3.8.1/dvc/repo/get.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/get_url.py` & `dvc-3.8.1/dvc/repo/get_url.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/graph.py` & `dvc-3.8.1/dvc/repo/graph.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/imp_url.py` & `dvc-3.8.1/dvc/repo/imp_url.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/imports.py` & `dvc-3.8.1/dvc/repo/imports.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/index.py` & `dvc-3.8.1/dvc/repo/index.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/init.py` & `dvc-3.8.1/dvc/repo/init.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/install.py` & `dvc-3.8.1/dvc/repo/install.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/ls.py` & `dvc-3.8.1/dvc/repo/ls.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/ls_url.py` & `dvc-3.8.1/dvc/repo/ls_url.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/metrics/diff.py` & `dvc-3.8.1/dvc/repo/metrics/diff.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/metrics/show.py` & `dvc-3.8.1/dvc/repo/metrics/show.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/move.py` & `dvc-3.8.1/dvc/repo/move.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/open_repo.py` & `dvc-3.8.1/dvc/repo/open_repo.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/params/diff.py` & `dvc-3.8.1/dvc/repo/params/diff.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/params/show.py` & `dvc-3.8.1/dvc/repo/params/show.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/plots/__init__.py` & `dvc-3.8.1/dvc/repo/plots/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/plots/diff.py` & `dvc-3.8.1/dvc/repo/plots/diff.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/pull.py` & `dvc-3.8.1/dvc/repo/pull.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/push.py` & `dvc-3.8.1/dvc/repo/push.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/remove.py` & `dvc-3.8.1/dvc/repo/remove.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/reproduce.py` & `dvc-3.8.1/dvc/repo/reproduce.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/run.py` & `dvc-3.8.1/dvc/repo/run.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/scm_context.py` & `dvc-3.8.1/dvc/repo/scm_context.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/stage.py` & `dvc-3.8.1/dvc/repo/stage.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/status.py` & `dvc-3.8.1/dvc/repo/status.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/trie.py` & `dvc-3.8.1/dvc/repo/trie.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/update.py` & `dvc-3.8.1/dvc/repo/update.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/repo/worktree.py` & `dvc-3.8.1/dvc/repo/worktree.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/rwlock.py` & `dvc-3.8.1/dvc/rwlock.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/schema.py` & `dvc-3.8.1/dvc/schema.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/scm.py` & `dvc-3.8.1/dvc/scm.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/stage/__init__.py` & `dvc-3.8.1/dvc/stage/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/stage/cache.py` & `dvc-3.8.1/dvc/stage/cache.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/stage/decorators.py` & `dvc-3.8.1/dvc/stage/decorators.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/stage/exceptions.py` & `dvc-3.8.1/dvc/stage/exceptions.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/stage/imports.py` & `dvc-3.8.1/dvc/stage/imports.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/stage/loader.py` & `dvc-3.8.1/dvc/stage/loader.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/stage/run.py` & `dvc-3.8.1/dvc/stage/run.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/stage/serialize.py` & `dvc-3.8.1/dvc/stage/serialize.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/stage/utils.py` & `dvc-3.8.1/dvc/stage/utils.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/testing/README.rst` & `dvc-3.8.1/dvc/testing/README.rst`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/testing/api_tests.py` & `dvc-3.8.1/dvc/testing/api_tests.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/testing/benchmarks/cli/commands/test_checkout.py` & `dvc-3.8.1/dvc/testing/benchmarks/cli/commands/test_checkout.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/testing/benchmarks/cli/commands/test_data_status.py` & `dvc-3.8.1/dvc/testing/benchmarks/cli/commands/test_data_status.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/testing/benchmarks/cli/commands/test_plots.py` & `dvc-3.8.1/dvc/testing/benchmarks/cli/commands/test_plots.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/testing/benchmarks/cli/stories/test_modify_data.py` & `dvc-3.8.1/dvc/testing/benchmarks/cli/stories/test_modify_data.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/testing/benchmarks/fixtures.py` & `dvc-3.8.1/dvc/testing/benchmarks/fixtures.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/testing/benchmarks/plugin.py` & `dvc-3.8.1/dvc/testing/benchmarks/plugin.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/testing/cloud.py` & `dvc-3.8.1/dvc/testing/cloud.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/testing/fixtures.py` & `dvc-3.8.1/dvc/testing/fixtures.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/testing/path_info.py` & `dvc-3.8.1/dvc/testing/path_info.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/testing/plugin.py` & `dvc-3.8.1/dvc/testing/plugin.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/testing/remote_tests.py` & `dvc-3.8.1/dvc/testing/remote_tests.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/testing/tmp_dir.py` & `dvc-3.8.1/dvc/testing/tmp_dir.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/testing/workspace_tests.py` & `dvc-3.8.1/dvc/testing/workspace_tests.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/ui/__init__.py` & `dvc-3.8.1/dvc/ui/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/ui/_rich_progress.py` & `dvc-3.8.1/dvc/ui/_rich_progress.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/ui/pager.py` & `dvc-3.8.1/dvc/ui/pager.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/ui/table.py` & `dvc-3.8.1/dvc/ui/table.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/updater.py` & `dvc-3.8.1/dvc/updater.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/utils/__init__.py` & `dvc-3.8.1/dvc/utils/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/utils/cli_parse.py` & `dvc-3.8.1/dvc/utils/cli_parse.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/utils/collections.py` & `dvc-3.8.1/dvc/utils/collections.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/utils/diff.py` & `dvc-3.8.1/dvc/utils/diff.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/utils/fs.py` & `dvc-3.8.1/dvc/utils/fs.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/utils/humanize.py` & `dvc-3.8.1/dvc/utils/humanize.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/utils/hydra.py` & `dvc-3.8.1/dvc/utils/hydra.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/utils/serialize/__init__.py` & `dvc-3.8.1/dvc/utils/serialize/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/utils/serialize/_common.py` & `dvc-3.8.1/dvc/utils/serialize/_common.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/utils/serialize/_json.py` & `dvc-3.8.1/dvc/utils/serialize/_json.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/utils/serialize/_py.py` & `dvc-3.8.1/dvc/utils/serialize/_py.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/utils/serialize/_toml.py` & `dvc-3.8.1/dvc/utils/serialize/_toml.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/utils/serialize/_yaml.py` & `dvc-3.8.1/dvc/utils/serialize/_yaml.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/utils/strictyaml.py` & `dvc-3.8.1/dvc/utils/strictyaml.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/utils/studio.py` & `dvc-3.8.1/dvc/utils/studio.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/utils/table.py` & `dvc-3.8.1/dvc/utils/table.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc/utils/threadpool.py` & `dvc-3.8.1/dvc/utils/threadpool.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc.egg-info/PKG-INFO` & `dvc-3.8.1/dvc.egg-info/PKG-INFO`
...
### Comparing `dvc-3.8.0/dvc.egg-info/SOURCES.txt` & `dvc-3.8.1/dvc.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/dvc.egg-info/requires.txt` & `dvc-3.8.1/dvc.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/pyproject.toml` & `dvc-3.8.1/pyproject.toml`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/conftest.py` & `dvc-3.8.1/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/dir_helpers.py` & `dvc-3.8.1/tests/dir_helpers.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/api/test_data.py` & `dvc-3.8.1/tests/func/api/test_data.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/api/test_experiments.py` & `dvc-3.8.1/tests/func/api/test_experiments.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/api/test_scm.py` & `dvc-3.8.1/tests/func/api/test_scm.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/api/test_show.py` & `dvc-3.8.1/tests/func/api/test_show.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/artifacts/test_artifacts.py` & `dvc-3.8.1/tests/func/artifacts/test_artifacts.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/data/db/test_index.py` & `dvc-3.8.1/tests/func/data/db/test_index.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/experiments/conftest.py` & `dvc-3.8.1/tests/func/experiments/conftest.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/experiments/executor/test_ssh.py` & `dvc-3.8.1/tests/func/experiments/executor/test_ssh.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/experiments/test_apply.py` & `dvc-3.8.1/tests/func/experiments/test_apply.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/experiments/test_diff.py` & `dvc-3.8.1/tests/func/experiments/test_diff.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/experiments/test_experiments.py` & `dvc-3.8.1/tests/func/experiments/test_experiments.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/experiments/test_queue.py` & `dvc-3.8.1/tests/func/experiments/test_queue.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/experiments/test_remote.py` & `dvc-3.8.1/tests/func/experiments/test_remote.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/experiments/test_remove.py` & `dvc-3.8.1/tests/func/experiments/test_remove.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/experiments/test_save.py` & `dvc-3.8.1/tests/func/experiments/test_save.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/experiments/test_set_params.py` & `dvc-3.8.1/tests/func/experiments/test_set_params.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/experiments/test_show.py` & `dvc-3.8.1/tests/func/experiments/test_show.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/experiments/test_stash_exp.py` & `dvc-3.8.1/tests/func/experiments/test_stash_exp.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/experiments/test_utils.py` & `dvc-3.8.1/tests/func/experiments/test_utils.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/machine/conftest.py` & `dvc-3.8.1/tests/func/machine/conftest.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/machine/test_machine_config.py` & `dvc-3.8.1/tests/func/machine/test_machine_config.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/machine/test_machine_status.py` & `dvc-3.8.1/tests/func/machine/test_machine_status.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/metrics/test_diff.py` & `dvc-3.8.1/tests/func/metrics/test_diff.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/metrics/test_show.py` & `dvc-3.8.1/tests/func/metrics/test_show.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/params/test_diff.py` & `dvc-3.8.1/tests/func/params/test_diff.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/params/test_show.py` & `dvc-3.8.1/tests/func/params/test_show.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/parsing/__init__.py` & `dvc-3.8.1/tests/func/parsing/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/parsing/test_errors.py` & `dvc-3.8.1/tests/func/parsing/test_errors.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/parsing/test_foreach.py` & `dvc-3.8.1/tests/func/parsing/test_foreach.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/parsing/test_interpolated_entry.py` & `dvc-3.8.1/tests/func/parsing/test_interpolated_entry.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/parsing/test_resolver.py` & `dvc-3.8.1/tests/func/parsing/test_resolver.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/plots/test_diff.py` & `dvc-3.8.1/tests/func/plots/test_diff.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/plots/test_modify.py` & `dvc-3.8.1/tests/func/plots/test_modify.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/plots/test_show.py` & `dvc-3.8.1/tests/func/plots/test_show.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/repro/test_repro.py` & `dvc-3.8.1/tests/func/repro/test_repro.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/repro/test_repro_allow_missing.py` & `dvc-3.8.1/tests/func/repro/test_repro_allow_missing.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/repro/test_repro_pull.py` & `dvc-3.8.1/tests/func/repro/test_repro_pull.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_add.py` & `dvc-3.8.1/tests/func/test_add.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_analytics.py` & `dvc-3.8.1/tests/func/test_analytics.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_check_ignore.py` & `dvc-3.8.1/tests/func/test_check_ignore.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_checkout.py` & `dvc-3.8.1/tests/func/test_checkout.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_cli.py` & `dvc-3.8.1/tests/func/test_cli.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_commit.py` & `dvc-3.8.1/tests/func/test_commit.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_config.py` & `dvc-3.8.1/tests/func/test_config.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_data_cloud.py` & `dvc-3.8.1/tests/func/test_data_cloud.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_data_status.py` & `dvc-3.8.1/tests/func/test_data_status.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_diff.py` & `dvc-3.8.1/tests/func/test_diff.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_dvcfile.py` & `dvc-3.8.1/tests/func/test_dvcfile.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_external_repo.py` & `dvc-3.8.1/tests/func/test_external_repo.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_fs.py` & `dvc-3.8.1/tests/func/test_fs.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_gc.py` & `dvc-3.8.1/tests/func/test_gc.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_get.py` & `dvc-3.8.1/tests/func/test_get.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_get_url.py` & `dvc-3.8.1/tests/func/test_get_url.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_ignore.py` & `dvc-3.8.1/tests/func/test_ignore.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_import.py` & `dvc-3.8.1/tests/func/test_import.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_import_url.py` & `dvc-3.8.1/tests/func/test_import_url.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_init.py` & `dvc-3.8.1/tests/func/test_init.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_install.py` & `dvc-3.8.1/tests/func/test_install.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_lock.py` & `dvc-3.8.1/tests/func/test_lock.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_lockfile.py` & `dvc-3.8.1/tests/func/test_lockfile.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_ls.py` & `dvc-3.8.1/tests/func/test_ls.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_merge_driver.py` & `dvc-3.8.1/tests/func/test_merge_driver.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_move.py` & `dvc-3.8.1/tests/func/test_move.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_odb.py` & `dvc-3.8.1/tests/func/test_odb.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_remote.py` & `dvc-3.8.1/tests/func/test_remote.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_remove.py` & `dvc-3.8.1/tests/func/test_remove.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_repo.py` & `dvc-3.8.1/tests/func/test_repo.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_repo_index.py` & `dvc-3.8.1/tests/func/test_repo_index.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_run.py` & `dvc-3.8.1/tests/func/test_run.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_run_cache.py` & `dvc-3.8.1/tests/func/test_run_cache.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_scm.py` & `dvc-3.8.1/tests/func/test_scm.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_scm_context.py` & `dvc-3.8.1/tests/func/test_scm_context.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_stage.py` & `dvc-3.8.1/tests/func/test_stage.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_stage_load.py` & `dvc-3.8.1/tests/func/test_stage_load.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_state.py` & `dvc-3.8.1/tests/func/test_state.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_status.py` & `dvc-3.8.1/tests/func/test_status.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_unprotect.py` & `dvc-3.8.1/tests/func/test_unprotect.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_update.py` & `dvc-3.8.1/tests/func/test_update.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_used_objs.py` & `dvc-3.8.1/tests/func/test_used_objs.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_utils.py` & `dvc-3.8.1/tests/func/test_utils.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_version.py` & `dvc-3.8.1/tests/func/test_version.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/test_virtual_directory.py` & `dvc-3.8.1/tests/func/test_virtual_directory.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/utils/test_hydra.py` & `dvc-3.8.1/tests/func/utils/test_hydra.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/func/utils/test_strict_yaml.py` & `dvc-3.8.1/tests/func/utils/test_strict_yaml.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/integration/plots/conftest.py` & `dvc-3.8.1/tests/integration/plots/conftest.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/integration/plots/test_plots.py` & `dvc-3.8.1/tests/integration/plots/test_plots.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/integration/plots/test_repo_plots_api.py` & `dvc-3.8.1/tests/integration/plots/test_repo_plots_api.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/integration/test_studio_live_experiments.py` & `dvc-3.8.1/tests/integration/test_studio_live_experiments.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/remotes/git_server.py` & `dvc-3.8.1/tests/remotes/git_server.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/remotes/user.key` & `dvc-3.8.1/tests/remotes/user.key`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/remotes_env.sample` & `dvc-3.8.1/tests/remotes_env.sample`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/scripts.py` & `dvc-3.8.1/tests/scripts.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/cli/test_main.py` & `dvc-3.8.1/tests/unit/cli/test_main.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/ls/test_ls.py` & `dvc-3.8.1/tests/unit/command/ls/test_ls.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/ls/test_ls_colors.py` & `dvc-3.8.1/tests/unit/command/ls/test_ls_colors.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_add.py` & `dvc-3.8.1/tests/unit/command/test_add.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_cache.py` & `dvc-3.8.1/tests/unit/command/test_cache.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_checkout.py` & `dvc-3.8.1/tests/unit/command/test_checkout.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_compat_flag.py` & `dvc-3.8.1/tests/unit/command/test_compat_flag.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_config.py` & `dvc-3.8.1/tests/unit/command/test_config.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_dag.py` & `dvc-3.8.1/tests/unit/command/test_dag.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_data_status.py` & `dvc-3.8.1/tests/unit/command/test_data_status.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_data_sync.py` & `dvc-3.8.1/tests/unit/command/test_data_sync.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_diff.py` & `dvc-3.8.1/tests/unit/command/test_diff.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_experiments.py` & `dvc-3.8.1/tests/unit/command/test_experiments.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_gc.py` & `dvc-3.8.1/tests/unit/command/test_gc.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_get.py` & `dvc-3.8.1/tests/unit/command/test_get.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_git_hook.py` & `dvc-3.8.1/tests/unit/command/test_git_hook.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_imp.py` & `dvc-3.8.1/tests/unit/command/test_imp.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_imp_url.py` & `dvc-3.8.1/tests/unit/command/test_imp_url.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_ls_url.py` & `dvc-3.8.1/tests/unit/command/test_ls_url.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_machine.py` & `dvc-3.8.1/tests/unit/command/test_machine.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_metrics.py` & `dvc-3.8.1/tests/unit/command/test_metrics.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_params.py` & `dvc-3.8.1/tests/unit/command/test_params.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_plots.py` & `dvc-3.8.1/tests/unit/command/test_plots.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_queue.py` & `dvc-3.8.1/tests/unit/command/test_queue.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_repro.py` & `dvc-3.8.1/tests/unit/command/test_repro.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_stage.py` & `dvc-3.8.1/tests/unit/command/test_stage.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_status.py` & `dvc-3.8.1/tests/unit/command/test_status.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/command/test_update.py` & `dvc-3.8.1/tests/unit/command/test_update.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/data/db/test_local.py` & `dvc-3.8.1/tests/unit/data/db/test_local.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/dependency/test_params.py` & `dvc-3.8.1/tests/unit/dependency/test_params.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/fs/test_azure.py` & `dvc-3.8.1/tests/unit/fs/test_azure.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/fs/test_data.py` & `dvc-3.8.1/tests/unit/fs/test_data.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/fs/test_dvc.py` & `dvc-3.8.1/tests/unit/fs/test_dvc.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/fs/test_dvc_info.py` & `dvc-3.8.1/tests/unit/fs/test_dvc_info.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/fs/test_fs.py` & `dvc-3.8.1/tests/unit/fs/test_fs.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/fs/test_path.py` & `dvc-3.8.1/tests/unit/fs/test_path.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/fs/test_s3.py` & `dvc-3.8.1/tests/unit/fs/test_s3.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/fs/test_tree.py` & `dvc-3.8.1/tests/unit/fs/test_tree.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/machine/test_machine.py` & `dvc-3.8.1/tests/unit/machine/test_machine.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/output/test_load.py` & `dvc-3.8.1/tests/unit/output/test_load.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/output/test_local.py` & `dvc-3.8.1/tests/unit/output/test_local.py`
...
### Comparing `dvc-3.8.0/tests/unit/output/test_output.py` & `dvc-3.8.1/tests/unit/output/test_output.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/remote/test_oss.py` & `dvc-3.8.1/tests/unit/remote/test_oss.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/remote/test_remote.py` & `dvc-3.8.1/tests/unit/remote/test_remote.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/remote/test_webdav.py` & `dvc-3.8.1/tests/unit/remote/test_webdav.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/remote/test_webhdfs.py` & `dvc-3.8.1/tests/unit/remote/test_webhdfs.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/render/test_convert.py` & `dvc-3.8.1/tests/unit/render/test_convert.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/render/test_image_converter.py` & `dvc-3.8.1/tests/unit/render/test_image_converter.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/render/test_match.py` & `dvc-3.8.1/tests/unit/render/test_match.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/render/test_vega_converter.py` & `dvc-3.8.1/tests/unit/render/test_vega_converter.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/repo/experiments/conftest.py` & `dvc-3.8.1/tests/unit/repo/experiments/conftest.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/repo/experiments/queue/test_celery.py` & `dvc-3.8.1/tests/unit/repo/experiments/queue/test_celery.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/repo/experiments/queue/test_remove.py` & `dvc-3.8.1/tests/unit/repo/experiments/queue/test_remove.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/repo/experiments/test_collect.py` & `dvc-3.8.1/tests/unit/repo/experiments/test_collect.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/repo/experiments/test_executor_status.py` & `dvc-3.8.1/tests/unit/repo/experiments/test_executor_status.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/repo/experiments/test_remove.py` & `dvc-3.8.1/tests/unit/repo/experiments/test_remove.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/repo/experiments/test_utils.py` & `dvc-3.8.1/tests/unit/repo/experiments/test_utils.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/repo/plots/test_diff.py` & `dvc-3.8.1/tests/unit/repo/plots/test_diff.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/repo/test_graph.py` & `dvc-3.8.1/tests/unit/repo/test_graph.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/repo/test_open_repo.py` & `dvc-3.8.1/tests/unit/repo/test_open_repo.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/repo/test_repo.py` & `dvc-3.8.1/tests/unit/repo/test_repo.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/repo/test_reproduce.py` & `dvc-3.8.1/tests/unit/repo/test_reproduce.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/repo/test_scm_context.py` & `dvc-3.8.1/tests/unit/repo/test_scm_context.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/scm/test_scm.py` & `dvc-3.8.1/tests/unit/scm/test_scm.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/stage/test_cache.py` & `dvc-3.8.1/tests/unit/stage/test_cache.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/stage/test_loader_pipeline_file.py` & `dvc-3.8.1/tests/unit/stage/test_loader_pipeline_file.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/stage/test_run.py` & `dvc-3.8.1/tests/unit/stage/test_run.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/stage/test_serialize_pipeline_file.py` & `dvc-3.8.1/tests/unit/stage/test_serialize_pipeline_file.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/stage/test_serialize_pipeline_lock.py` & `dvc-3.8.1/tests/unit/stage/test_serialize_pipeline_lock.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/stage/test_stage.py` & `dvc-3.8.1/tests/unit/stage/test_stage.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/stage/test_utils.py` & `dvc-3.8.1/tests/unit/stage/test_utils.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_analytics.py` & `dvc-3.8.1/tests/unit/test_analytics.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_collect.py` & `dvc-3.8.1/tests/unit/test_collect.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_compare.py` & `dvc-3.8.1/tests/unit/test_compare.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_config.py` & `dvc-3.8.1/tests/unit/test_config.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_context.py` & `dvc-3.8.1/tests/unit/test_context.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_daemon.py` & `dvc-3.8.1/tests/unit/test_daemon.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_dvcfile.py` & `dvc-3.8.1/tests/unit/test_dvcfile.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_ignore.py` & `dvc-3.8.1/tests/unit/test_ignore.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_imports.py` & `dvc-3.8.1/tests/unit/test_imports.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_info.py` & `dvc-3.8.1/tests/unit/test_info.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_interpolate.py` & `dvc-3.8.1/tests/unit/test_interpolate.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_lockfile.py` & `dvc-3.8.1/tests/unit/test_lockfile.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_logger.py` & `dvc-3.8.1/tests/unit/test_logger.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_metrics.py` & `dvc-3.8.1/tests/unit/test_metrics.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_params.py` & `dvc-3.8.1/tests/unit/test_params.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_pathspec_math.py` & `dvc-3.8.1/tests/unit/test_pathspec_math.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_progress.py` & `dvc-3.8.1/tests/unit/test_progress.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_rwlock.py` & `dvc-3.8.1/tests/unit/test_rwlock.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_tabular_data.py` & `dvc-3.8.1/tests/unit/test_tabular_data.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/test_updater.py` & `dvc-3.8.1/tests/unit/test_updater.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/ui/test_console.py` & `dvc-3.8.1/tests/unit/ui/test_console.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/ui/test_pager.py` & `dvc-3.8.1/tests/unit/ui/test_pager.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/ui/test_table.py` & `dvc-3.8.1/tests/unit/ui/test_table.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/utils/serialize/test_python.py` & `dvc-3.8.1/tests/unit/utils/serialize/test_python.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/utils/serialize/test_toml.py` & `dvc-3.8.1/tests/unit/utils/serialize/test_toml.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/utils/serialize/test_yaml.py` & `dvc-3.8.1/tests/unit/utils/serialize/test_yaml.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/utils/test_cli_parse.py` & `dvc-3.8.1/tests/unit/utils/test_cli_parse.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/utils/test_collections.py` & `dvc-3.8.1/tests/unit/utils/test_collections.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/utils/test_executors.py` & `dvc-3.8.1/tests/unit/utils/test_executors.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/utils/test_fs.py` & `dvc-3.8.1/tests/unit/utils/test_fs.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/utils/test_humanize.py` & `dvc-3.8.1/tests/unit/utils/test_humanize.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/utils/test_studio.py` & `dvc-3.8.1/tests/unit/utils/test_studio.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/unit/utils/test_utils.py` & `dvc-3.8.1/tests/unit/utils/test_utils.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/utils/__init__.py` & `dvc-3.8.1/tests/utils/__init__.py`

 * *Files identical despite different names*

### Comparing `dvc-3.8.0/tests/utils/asserts.py` & `dvc-3.8.1/tests/utils/asserts.py`
