# Comparing `tmp/discovery-capability-0.4.4.tar.gz` & `tmp/discovery-capability-0.4.5.tar.gz`
...
### Comparing `discovery-capability-0.4.4/LICENSE.txt` & `discovery-capability-0.4.5/LICENSE.txt`
