# Comparing `tmp/dukeai_lib-0.1.7.tar.gz` & `tmp/dukeai_lib-0.1.8.tar.gz`
...
## Comparing `dukeai_lib-0.1.7.tar` & `dukeai_lib-0.1.8.tar`
...
### Comparing `dukeai_lib-0.1.7/LICENSE` & `dukeai_lib-0.1.8/LICENSE`

 * *Files identical despite different names*

### Comparing `dukeai_lib-0.1.7/dukeai_lib/application.py` & `dukeai_lib-0.1.8/dukeai_lib/application.py`

 * *Files identical despite different names*

### Comparing `dukeai_lib-0.1.7/dukeai_lib/tools.py` & `dukeai_lib-0.1.8/dukeai_lib/tools.py`

 * *Files identical despite different names*

### Comparing `dukeai_lib-0.1.7/pyproject.toml` & `dukeai_lib-0.1.8/pyproject.toml`
...
### Comparing `dukeai_lib-0.1.7/setup.py` & `dukeai_lib-0.1.8/setup.py`
...
### Comparing `dukeai_lib-0.1.7/src/application.py` & `dukeai_lib-0.1.8/src/application.py`
...
### Comparing `dukeai_lib-0.1.7/src/tools.py` & `dukeai_lib-0.1.8/src/tools.py`
