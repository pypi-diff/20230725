# Comparing `tmp/zerocap_websocket_test-1.0.3.tar.gz` & `tmp/zerocap_websocket_test-1.0.4.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "zerocap_websocket_test-1.0.3.tar", last modified: Tue Jul 25 02:09:58 2023, max compression
+gzip compressed data, was "zerocap_websocket_test-1.0.4.tar", last modified: Tue Jul 25 02:11:05 2023, max compression
```

## Comparing `zerocap_websocket_test-1.0.3.tar` & `zerocap_websocket_test-1.0.4.tar`

### file list

```diff
@@ -1,14 +1,14 @@
-drwxr-xr-x   0 gao        (501) staff       (20)        0 2023-07-25 02:09:58.348137 zerocap_websocket_test-1.0.3/
--rw-r--r--   0 gao        (501) staff       (20)    11323 2023-07-21 07:23:19.000000 zerocap_websocket_test-1.0.3/LICENSE.txt
--rw-r--r--   0 gao        (501) staff       (20)     1329 2023-07-25 02:09:58.347577 zerocap_websocket_test-1.0.3/PKG-INFO
--rw-r--r--   0 gao        (501) staff       (20)       38 2023-07-25 02:09:58.348254 zerocap_websocket_test-1.0.3/setup.cfg
--rw-r--r--   0 gao        (501) staff       (20)      799 2023-07-25 02:05:50.000000 zerocap_websocket_test-1.0.3/setup.py
-drwxr-xr-x   0 gao        (501) staff       (20)        0 2023-07-25 02:09:58.343668 zerocap_websocket_test-1.0.3/zerocap_websocket_test/
--rw-r--r--   0 gao        (501) staff       (20)       80 2023-07-21 08:10:24.000000 zerocap_websocket_test-1.0.3/zerocap_websocket_test/__init__.py
--rw-r--r--   0 gao        (501) staff       (20)     3259 2023-07-25 01:52:08.000000 zerocap_websocket_test-1.0.3/zerocap_websocket_test/main.py
-drwxr-xr-x   0 gao        (501) staff       (20)        0 2023-07-25 02:09:58.346907 zerocap_websocket_test-1.0.3/zerocap_websocket_test.egg-info/
--rw-r--r--   0 gao        (501) staff       (20)     1329 2023-07-25 02:09:58.000000 zerocap_websocket_test-1.0.3/zerocap_websocket_test.egg-info/PKG-INFO
--rw-r--r--   0 gao        (501) staff       (20)      315 2023-07-25 02:09:58.000000 zerocap_websocket_test-1.0.3/zerocap_websocket_test.egg-info/SOURCES.txt
--rw-r--r--   0 gao        (501) staff       (20)        1 2023-07-25 02:09:58.000000 zerocap_websocket_test-1.0.3/zerocap_websocket_test.egg-info/dependency_links.txt
--rw-r--r--   0 gao        (501) staff       (20)       19 2023-07-25 02:09:58.000000 zerocap_websocket_test-1.0.3/zerocap_websocket_test.egg-info/requires.txt
--rw-r--r--   0 gao        (501) staff       (20)       23 2023-07-25 02:09:58.000000 zerocap_websocket_test-1.0.3/zerocap_websocket_test.egg-info/top_level.txt
...
### Comparing `zerocap_websocket_test-1.0.3/LICENSE.txt` & `zerocap_websocket_test-1.0.4/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `zerocap_websocket_test-1.0.3/PKG-INFO` & `zerocap_websocket_test-1.0.4/zerocap_websocket_test.egg-info/PKG-INFO`
...
### Comparing `zerocap_websocket_test-1.0.3/setup.py` & `zerocap_websocket_test-1.0.4/setup.py`
...
### Comparing `zerocap_websocket_test-1.0.3/zerocap_websocket_test/main.py` & `zerocap_websocket_test-1.0.4/zerocap_websocket_test/main.py`
