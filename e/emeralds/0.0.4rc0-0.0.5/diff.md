# Comparing `tmp/emeralds-0.0.4rc0.tar.gz` & `tmp/emeralds-0.0.5.tar.gz`
...
+gzip compressed data, was "emeralds-0.0.5.tar", last modified: Tue Jul 25 06:37:17 2023, max compression
```

## Comparing `emeralds-0.0.4rc0.tar` & `emeralds-0.0.5.tar`
...
+drwxrwxrwx   0        0        0        0 2023-07-25 06:37:17.249818 emeralds-0.0.5/
+-rw-rw-rw-   0        0        0     1330 2023-07-24 23:06:47.000000 emeralds-0.0.5/LICENSE.txt
+-rw-rw-rw-   0        0        0     1102 2023-07-25 06:37:17.249818 emeralds-0.0.5/PKG-INFO
+-rw-rw-rw-   0        0        0       54 2023-07-24 23:06:47.000000 emeralds-0.0.5/README.md
+drwxrwxrwx   0        0        0        0 2023-07-25 06:37:17.222811 emeralds-0.0.5/emeralds/
+-rw-rw-rw-   0        0        0        0 2023-07-25 04:13:00.000000 emeralds-0.0.5/emeralds/__init__.py
+drwxrwxrwx   0        0        0        0 2023-07-25 06:37:17.245816 emeralds-0.0.5/emeralds/cryptography/
+-rw-rw-rw-   0        0        0      328 2023-07-25 04:28:45.000000 emeralds-0.0.5/emeralds/cryptography/__init__.py
+-rw-rw-rw-   0        0        0     2376 2023-07-25 05:59:22.000000 emeralds-0.0.5/emeralds/cryptography/checksums.py
+drwxrwxrwx   0        0        0        0 2023-07-25 06:37:17.248817 emeralds-0.0.5/emeralds/tools/
+-rw-rw-rw-   0        0        0      353 2023-07-25 04:28:51.000000 emeralds-0.0.5/emeralds/tools/__init__.py
+-rw-rw-rw-   0        0        0     2116 2023-07-22 03:52:54.000000 emeralds-0.0.5/emeralds/tools/colors.py
+-rw-rw-rw-   0        0        0     8068 2023-07-25 05:59:29.000000 emeralds-0.0.5/emeralds/tools/logger.py
+drwxrwxrwx   0        0        0        0 2023-07-25 06:37:17.243816 emeralds-0.0.5/emeralds.egg-info/
+-rw-rw-rw-   0        0        0     1102 2023-07-25 06:37:17.000000 emeralds-0.0.5/emeralds.egg-info/PKG-INFO
+-rw-rw-rw-   0        0        0      356 2023-07-25 06:37:17.000000 emeralds-0.0.5/emeralds.egg-info/SOURCES.txt
+-rw-rw-rw-   0        0        0        1 2023-07-25 06:37:17.000000 emeralds-0.0.5/emeralds.egg-info/dependency_links.txt
+-rw-rw-rw-   0        0        0       52 2023-07-25 06:37:17.000000 emeralds-0.0.5/emeralds.egg-info/requires.txt
+-rw-rw-rw-   0        0        0        9 2023-07-25 06:37:17.000000 emeralds-0.0.5/emeralds.egg-info/top_level.txt
+-rw-rw-rw-   0        0        0       42 2023-07-25 06:37:17.249818 emeralds-0.0.5/setup.cfg
+-rw-rw-rw-   0        0        0     3976 2023-07-25 06:36:47.000000 emeralds-0.0.5/setup.py
```

### Comparing `emeralds-0.0.4rc0/LICENSE.txt` & `emeralds-0.0.5/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `emeralds-0.0.4rc0/PKG-INFO` & `emeralds-0.0.5/PKG-INFO`
...
+
+Built with Autumn (Jason's AI) — 2023-07-25 @ 02:37:17
```

### Comparing `emeralds-0.0.4rc0/emeralds/cryptography/checksums.py` & `emeralds-0.0.5/emeralds/cryptography/checksums.py`

 * *Files identical despite different names*

### Comparing `emeralds-0.0.4rc0/emeralds/tools/colors.py` & `emeralds-0.0.5/emeralds/tools/colors.py`

 * *Files identical despite different names*

### Comparing `emeralds-0.0.4rc0/emeralds/tools/logger.py` & `emeralds-0.0.5/emeralds/tools/logger.py`

 * *Files identical despite different names*

### Comparing `emeralds-0.0.4rc0/emeralds.egg-info/PKG-INFO` & `emeralds-0.0.5/emeralds.egg-info/PKG-INFO`
...
### Comparing `emeralds-0.0.4rc0/setup.py` & `emeralds-0.0.5/setup.py`
