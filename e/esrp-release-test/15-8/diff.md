# Comparing `tmp/esrp-release-test-15.tar.gz` & `tmp/esrp-release-test-8.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "/home/vsts/work/1/s/dist/.tmp-1qcpi2jr/esrp-release-test-15.tar", last modified: Tue Jul 25 12:18:56 2023, max compression
+gzip compressed data, was "esrp-release-test-8.tar", last modified: Fri Feb  3 10:10:46 2023, max compression
```

## Comparing `esrp-release-test-15.tar` & `esrp-release-test-8.tar`

### file list

```diff
@@ -1,19 +1,19 @@
-drwxr-xr-x   0 vsts      (1001) docker     (123)        0 2023-07-25 12:18:56.000000 esrp-release-test-15/
--rw-r--r--   0 vsts      (1001) docker     (123)     1074 2023-07-25 12:18:34.000000 esrp-release-test-15/LICENSE
--rw-r--r--   0 vsts      (1001) docker     (123)      957 2023-07-25 12:18:56.000000 esrp-release-test-15/PKG-INFO
--rw-r--r--   0 vsts      (1001) docker     (123)      253 2023-07-25 12:18:34.000000 esrp-release-test-15/README.md
-drwxr-xr-x   0 vsts      (1001) docker     (123)        0 2023-07-25 12:18:56.000000 esrp-release-test-15/esrp-release-test/
--rw-r--r--   0 vsts      (1001) docker     (123)        0 2023-07-25 12:18:34.000000 esrp-release-test-15/esrp-release-test/__init__.py
-drwxr-xr-x   0 vsts      (1001) docker     (123)        0 2023-07-25 12:18:56.000000 esrp-release-test-15/esrp-release-test/src/
--rw-r--r--   0 vsts      (1001) docker     (123)       20 2023-07-25 12:18:34.000000 esrp-release-test-15/esrp-release-test/src/__init__.py
--rw-r--r--   0 vsts      (1001) docker     (123)       20 2023-07-25 12:18:34.000000 esrp-release-test-15/esrp-release-test/src/esrpreltest.py
-drwxr-xr-x   0 vsts      (1001) docker     (123)        0 2023-07-25 12:18:56.000000 esrp-release-test-15/esrp_release_test.egg-info/
--rw-r--r--   0 vsts      (1001) docker     (123)      957 2023-07-25 12:18:56.000000 esrp-release-test-15/esrp_release_test.egg-info/PKG-INFO
--rw-r--r--   0 vsts      (1001) docker     (123)      400 2023-07-25 12:18:56.000000 esrp-release-test-15/esrp_release_test.egg-info/SOURCES.txt
--rw-r--r--   0 vsts      (1001) docker     (123)        1 2023-07-25 12:18:56.000000 esrp-release-test-15/esrp_release_test.egg-info/dependency_links.txt
--rw-r--r--   0 vsts      (1001) docker     (123)       63 2023-07-25 12:18:56.000000 esrp-release-test-15/esrp_release_test.egg-info/entry_points.txt
--rw-r--r--   0 vsts      (1001) docker     (123)       71 2023-07-25 12:18:56.000000 esrp-release-test-15/esrp_release_test.egg-info/requires.txt
--rw-r--r--   0 vsts      (1001) docker     (123)       18 2023-07-25 12:18:56.000000 esrp-release-test-15/esrp_release_test.egg-info/top_level.txt
--rw-r--r--   0 vsts      (1001) docker     (123)       84 2023-07-25 12:18:34.000000 esrp-release-test-15/pyproject.toml
--rw-r--r--   0 vsts      (1001) docker     (123)     1125 2023-07-25 12:18:56.000000 esrp-release-test-15/setup.cfg
--rw-r--r--   0 vsts      (1001) docker     (123)       69 2023-07-25 12:18:34.000000 esrp-release-test-15/setup.py
...
### Comparing `esrp-release-test-15/PKG-INFO` & `esrp-release-test-8/PKG-INFO`
...
### Comparing `esrp-release-test-15/esrp_release_test.egg-info/PKG-INFO` & `esrp-release-test-8/esrp_release_test.egg-info/PKG-INFO`
...
### Comparing `esrp-release-test-15/setup.cfg` & `esrp-release-test-8/setup.cfg`
...
-00000020: 6573 740a 7665 7273 696f 6e20 3d20 3135  est.version = 15
