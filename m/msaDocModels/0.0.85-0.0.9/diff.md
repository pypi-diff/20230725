# Comparing `tmp/msaDocModels-0.0.85.tar.gz` & `tmp/msaDocModels-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "msaDocModels-0.0.85.tar", last modified: Tue Jul 25 12:53:01 2023, max compression
+gzip compressed data, was "msaDocModels-0.0.9.tar", last modified: Fri Nov 25 11:39:48 2022, max compression
```

## Comparing `msaDocModels-0.0.85.tar` & `msaDocModels-0.0.9.tar`

### file list

```diff
@@ -1,25 +1,24 @@
-drwxrwxr-x   0 vitaly    (1000) vitaly    (1000)        0 2023-07-25 12:53:01.108357 msaDocModels-0.0.85/
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     1099 2023-03-26 10:37:51.000000 msaDocModels-0.0.85/LICENCE
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     3679 2023-07-25 12:53:01.108357 msaDocModels-0.0.85/PKG-INFO
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     2198 2023-03-26 10:37:51.000000 msaDocModels-0.0.85/README.md
-drwxrwxr-x   0 vitaly    (1000) vitaly    (1000)        0 2023-07-25 12:53:01.108357 msaDocModels-0.0.85/msaDocModels/
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)      479 2023-07-25 12:52:54.000000 msaDocModels-0.0.85/msaDocModels/__init__.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)      562 2023-03-26 10:37:51.000000 msaDocModels-0.0.85/msaDocModels/health.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     3763 2023-03-26 10:37:51.000000 msaDocModels-0.0.85/msaDocModels/msg.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)      409 2023-07-24 12:37:21.000000 msaDocModels-0.0.85/msaDocModels/openapi.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     1113 2023-07-25 11:49:32.000000 msaDocModels-0.0.85/msaDocModels/pubsub.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     2413 2023-03-26 10:37:51.000000 msaDocModels-0.0.85/msaDocModels/scheduler.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)   155303 2023-07-25 11:50:16.000000 msaDocModels-0.0.85/msaDocModels/sdu.py
-drwxrwxr-x   0 vitaly    (1000) vitaly    (1000)        0 2023-07-25 12:53:01.108357 msaDocModels-0.0.85/msaDocModels/utils/
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)        0 2023-03-26 10:37:51.000000 msaDocModels-0.0.85/msaDocModels/utils/__init__.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     1826 2023-03-26 10:37:51.000000 msaDocModels-0.0.85/msaDocModels/utils/htmlutils.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)    22179 2023-03-26 10:37:51.000000 msaDocModels-0.0.85/msaDocModels/wdc.py
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     2103 2023-03-26 10:37:51.000000 msaDocModels-0.0.85/msaDocModels/wfl.py
-drwxrwxr-x   0 vitaly    (1000) vitaly    (1000)        0 2023-07-25 12:53:01.108357 msaDocModels-0.0.85/msaDocModels.egg-info/
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     3679 2023-07-25 12:53:01.000000 msaDocModels-0.0.85/msaDocModels.egg-info/PKG-INFO
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)      465 2023-07-25 12:53:01.000000 msaDocModels-0.0.85/msaDocModels.egg-info/SOURCES.txt
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)        1 2023-07-25 12:53:01.000000 msaDocModels-0.0.85/msaDocModels.egg-info/dependency_links.txt
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)       13 2023-07-25 12:53:01.000000 msaDocModels-0.0.85/msaDocModels.egg-info/top_level.txt
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)        1 2023-03-31 07:31:05.000000 msaDocModels-0.0.85/msaDocModels.egg-info/zip-safe
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)       38 2023-07-25 12:53:01.108357 msaDocModels-0.0.85/setup.cfg
--rw-rw-r--   0 vitaly    (1000) vitaly    (1000)     2164 2023-03-26 10:37:51.000000 msaDocModels-0.0.85/setup.py
...
### Comparing `msaDocModels-0.0.85/LICENCE` & `msaDocModels-0.0.9/LICENCE`

 * *Files identical despite different names*

### Comparing `msaDocModels-0.0.85/PKG-INFO` & `msaDocModels-0.0.9/PKG-INFO`
...
```diff
@@ -1,10 +1,10 @@
-Metadata-Version: 2.1 Name: msaDocModels Version: 0.0.85 Summary: msaDocModels
...
### Comparing `msaDocModels-0.0.85/README.md` & `msaDocModels-0.0.9/README.md`
...
### Comparing `msaDocModels-0.0.85/msaDocModels/health.py` & `msaDocModels-0.0.9/msaDocModels/health.py`

 * *Files identical despite different names*

### Comparing `msaDocModels-0.0.85/msaDocModels/msg.py` & `msaDocModels-0.0.9/msaDocModels/msg.py`
...
### Comparing `msaDocModels-0.0.85/msaDocModels/scheduler.py` & `msaDocModels-0.0.9/msaDocModels/scheduler.py`
...
### Comparing `msaDocModels-0.0.85/msaDocModels/utils/htmlutils.py` & `msaDocModels-0.0.9/msaDocModels/utils/htmlutils.py`
...
### Comparing `msaDocModels-0.0.85/msaDocModels/wdc.py` & `msaDocModels-0.0.9/msaDocModels/wdc.py`
...
### Comparing `msaDocModels-0.0.85/msaDocModels/wfl.py` & `msaDocModels-0.0.9/msaDocModels/wfl.py`
...
### Comparing `msaDocModels-0.0.85/msaDocModels.egg-info/PKG-INFO` & `msaDocModels-0.0.9/msaDocModels.egg-info/PKG-INFO`
