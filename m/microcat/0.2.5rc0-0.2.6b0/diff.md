# Comparing `tmp/microcat-0.2.5rc0.tar.gz` & `tmp/microcat-0.2.6b0.tar.gz`
...
### Comparing `microcat-0.2.5rc0/microcat/single_wf/rules/host.smk` & `microcat-0.2.6b0/microcat/single_wf/rules/host.smk`
