# Comparing `tmp/pip_services4_config-0.0.2.tar.gz` & `tmp/pip_services4_config-0.0.3.tar.gz`
...
### Comparing `pip_services4_config-0.0.2/setup.py` & `pip_services4_config-0.0.3/setup.py`
