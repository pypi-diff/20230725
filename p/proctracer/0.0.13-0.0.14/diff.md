# Comparing `tmp/proctracer-0.0.13.tar.gz` & `tmp/proctracer-0.0.14.tar.gz`
...
### Comparing `proctracer-0.0.13/proctracer/plugins/plugin_base.py` & `proctracer-0.0.14/proctracer/plugins/plugin_base.py`
